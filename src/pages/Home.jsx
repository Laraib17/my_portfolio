...
export default function Portfolio() {
  ...
  const projects = [
    ...
    {
      title: "Chat In Group (CIG)",
      description: "Cross-platform mobile app enabling real-time group messaging for 100+ concurrent users with Firebase integration.",
  ...
  const skills = {
    "Languages": ["Java", "Python", "C/C++", "JavaScript", "SQL", "Dart", "Kotlin"],
      ...
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20">
        <div className={`max-w-4xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
            CSE Student at Galgotias University | Building innovative web & mobile applications | 
            Open source contributor with passion for clean code and impactful solutions
          </p>
          <div className="flex gap-4 justify-center mb-12">
            <a href="https://github.com/laraib17" target="_blank" rel="noopener noreferrer" 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((project, index) => (
              <div key={index} className="bg-slate-800/50 p-6 rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition-all hover:transform hover:scale-105 group">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map(tech => (
                    <span key={tech} className="px-3 py-1 bg-slate-700/50 rounded-lg text-sm text-purple-300">
                      {tech}
                    </span>
                  ))}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {experience.map((exp, index) => (
              <div key={index} className="bg-slate-800/50 p-8 rounded-xl border border-purple-500/20 hover:border-purple-500/40 transition-all">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-4">
                  <div>
                    <h3 className="text-2xl font-semibold text-purple-300 mb-2">{exp.role}</h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-800/50 p-6 rounded-xl border border-purple-500/20 text-center hover:border-purple-500/40 transition-all hover:transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-2">15+ Repositories</h3>
      ...
      <section id="contact" className="py-20 px-6 bg-slate-900/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-400 mb-8">
            I'm currently seeking SDE Intern opportunities and open to collaborating on exciting projects
          </p>
